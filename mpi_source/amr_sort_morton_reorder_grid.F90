...
!!     This is a list of the morton numbers computed and returned by this subroutine.  Ne
...
!$MP DO			
	Do i = 1, tot_blocks
           lreflevel_old(i) = lreflevel_across(i)
	End Do
!$MP END DO
!$MP DO
        Do i = 1,tot_blocks
...
!$MP PARALLEL DO PRIVATE (idi, idp)
      Do i = 1,lnblocks
