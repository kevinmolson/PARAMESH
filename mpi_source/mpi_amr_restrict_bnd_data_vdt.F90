...
!!!!$MP PARALLEL DO PRIVATE(jchild, remote_pe, remote_block, remote_pe2, remote_block2, &
!!!!$MP                     iblk, cnodetype, cneigh, vtype, ia0, ib0, ja0, jb0, &
!!!!$MP                     ka0, kb0, icoord, index, index0, dtype, ia, ib, ja, jb, &
!!!!$MP                     ka, kb, i, j, k, n, iface, jface, kface, ioff, joff, &
!!!!$MP                     koff, ivar, ii, jj, kk, ich)
      do lb = 1,lnblocks
