...
!#define DEBUG
	  ...
	  call mpi_init_thread(MPI_THREAD_MULTIPLE, provided, ierr)
          print *,' !!!!!!!!!!!!! '
	  print *,' '
          print *,' USING OPEN MP ',provided,MPI_THREAD_MULTIPLE
	  print *,' '
          print *,' !!!!!!!!!!!!! '
#else
          print *,' !!!!!!!!!!!!! '
	  print *,' '
          print *,' NOT USING OPEN MP '
	  print *,' '
          print *,' !!!!!!!!!!!!! '
          call mpi_init(ierr)
#endif
...
!$OMP PARALLEL PRIVATE (isrc, idest, itag, ji, ij, istrt, ilast, isize, ierr, recvrequest, ierrorcode) 
      ij = 0
      ji = 0
!$OMP DO
      do i = 1,nprocs
...
!$OMP PARALLEL PRIVATE (isrc, idest, itag, ji, ij, istrt, ilast, isize, ierr, recvrequest) 
      ij = 0
      ji = 0
!$OMP DO
      do i = 1,nprocs
