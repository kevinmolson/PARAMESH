...
!!$MP PARALLEL PRIVATE(bndtempx1, bndtempy1, bndtempz1)
!!$MP                  recvarxf, recvaryf, recvarzf)
...
!!$MP DO PRIVATE(ich, jchild, remote_pe, remote_block, remote_pe2, &
!!$MP            remote_block2, lfound, iblk, cnodetype, cneigh, minn, maxx, &
!!$MP            vtype, dtype, ia0, ib0, ja0, jb0, ka0, kb0, icoord, index, &
!!$MP            index0, n, ivar, &
!!$MP            ia, ib, ja, jb, ka, kb, iface, jface, kface, &
!!$MP            ioff, joff, koff, i, j, k, ii, jj, kk)
      do lb = 1,lnblocks
