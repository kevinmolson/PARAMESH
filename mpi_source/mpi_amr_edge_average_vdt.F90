...
!-----are acquired which are needed in the restriction operation.
      ...
      If (lnblocks > 0) Then
!$MP PARALLEL PRIVATE(lcycle, phase0, phase1)
!$MP DO
      Do lb = 1,lnblocks
...
!-----update their edges.
!$MP PARALLEL PRIVATE(iface, cnodetype, remote_pe, remote_block)
!$MP DO
      Do lb = 1,lnblocks
...
!!!      If (lnblocks > 0) Then
!$MP DO PRIVATE(remote_pe, remote_block, remote_pe2, remote_block2, cnodetype, lfound)
      Do lb = 1,lnblocks
