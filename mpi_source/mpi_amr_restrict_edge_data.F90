...
!!$MP PARALLEL DO PRIVATE(ich, jchild, remote_pe, remote_block, remote_pe2, &
!!$MP                     remote_block2, lfound, iblk, cnodetype, cneigh, icoord, &
!!$MP                     iface, jface, kface, ioff, joff, koff, i, j, k,  &
!!$MP                     ii, jj, kk)
      do lb = 1,lnblocks
