...
!$MP PARALLEL PRIVATE(reqr, nrecv, ipar, ipar_proc, ierr, j, ix, iy, iz)
...
!$MP PARALLEL PRIVATE (reqr, statr, jr, jr0, nrecv, lrecv, ierr, lsend, ineigh, ineigh_proc, iz, iy, ix, iz_n, iy_n, ix_n)
!$MP DO 
         do i = 1,lnblocks
            ref_testt(:,:,:,i) = .FALSE.
            ref_testts(:,:,:,i) = .FALSE.
