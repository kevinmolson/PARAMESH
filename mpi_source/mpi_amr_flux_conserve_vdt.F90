...
!-----Begin executable code.
      ...
      If (lnblocks > 0) Then
!$MP PARALLEL
!$MP DO PRIVATE(lcycle, phase0, phase1)
      Do lb = 1,lnblocks
...
!-----update their fluxes.
!$MP PARALLEL
!$MP DO PRIVATE (iface, cnodetype, remote_pe, remote_block, iblk) 
      Do lb = 1,lnblocks
...
!-----cycle through the grid blocks on this processor
      If (lnblocks > 0) Then
!$MP PARALLEL
!$MP DO PRIVATE(jf, remote_pe, remote_block, remote_block2, cnodetype, lfound,  &
!$MP            dtype, index0, ia0, ib0, ja0, jb0, ka0, kb0, index,  &
!$MP            ia, ib, ja, jb, ka, kb, vtype)
      Do lb = 1,lnblocks
