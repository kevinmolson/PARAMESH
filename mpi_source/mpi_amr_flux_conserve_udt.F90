...
!-----cycle through the grid blocks on this processor
      If (lnblocks > 0) Then
!$MP PARALLEL
!$MP DO PRIVATE (jf, remote_pe, remote_block, remote_block2, remote_pe2,  &
!$MP             cnodetype, lfound, vtype, ia0, ib0, ja0, jb0, ka0, kb0, index, &
!$MP             ia, ib, ja, jb, ka, kb, index0, dtype)
      Do lb = 1,lnblocks
