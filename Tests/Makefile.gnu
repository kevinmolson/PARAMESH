...
# FOR NVIDIA COMPILER (WHat's libparamesh_kernel ???)
#LDFLAGS += $(paramesh_dir)/$(KERNELS)/libparamesh_kernels.a \
#${OPS_INSTALL_PATH}/fortran/lib/libops_for_seq.a \
#$(paramesh_dir)/libs/libmpi_paramesh.a \
#$(paramesh_dir)/libs/libparamesh.a \
#$(paramesh_dir)/libs/libmodules.a \
#$(paramesh_dir)/libs/libparamesh_kernels.a

LDFLAGS += $(paramesh_dir)/libs/libmpi_paramesh.a \
$(paramesh_dir)/libs/libparamesh.a \
$(paramesh_dir)/libs/libmodules.a 
...
ifndef SHMEM
#LDFLAGS += -lmpi_paramesh -lmodules -lparamesh -lparamesh_ops
endif
