...
unk = (float (*)[][*ku_bnd][*ju_bnd][*iu_bnd][*nvar]) c_amr_get_pointer("unk");
...
facevarx = (float (*)[][*ku_bnd][*ju_bnd][*iu_bnd+1][*nbndvar]) c_amr_get_pointer("facevarx");
(*facevarx)[0][0][0][0][0] = (*facevarx)[0][0][0][0][0];

float (*facevary)[*maxblocksf][*ku_bnd][*ju_bnd+*k2d][*iu_bnd][*nbndvar];
facevary = (float (*)[][*ku_bnd][*ju_bnd+*k2d][*iu_bnd][*nbndvar]) c_amr_get_pointer("facevary");
(*facevary)[0][0][0][0][0] = (*facevary)[0][0][0][0][0];

float (*facevarz)[*maxblocksf][*ku_bnd+*k3d][*ju_bnd][*iu_bnd][*nbndvar];
facevarz = (float (*)[][*ku_bnd+*k3d][*ju_bnd][*iu_bnd][*nbndvar]) c_amr_get_pointer("facevarz");
...
gcell_on_ec = (int (*)[][three_physicaldata]) c_amr_get_pointer("gcell_on_ec");
(*gcell_on_ec)[0][0] = (*gcell_on_ec)[0][0];

int (*checkp_on_ec)[*nbndvare][three_physicaldata];
checkp_on_ec = (int (*)[][three_physicaldata]) c_amr_get_pointer("checkp_on_ec");
(*checkp_on_ec)[0][0] = (*checkp_on_ec)[0][0];

float (*unk_n)[*maxblocksn][*ku_bnd+*k3d][*ju_bnd+*k2d][*iu_bnd+1][*nbndvarc];
unk_n = (float (*)[][*ku_bnd+*k3d][*ju_bnd+*k2d][*iu_bnd+1][*nbndvarc]) c_amr_get_pointer("unk_n");
...
flux_x = (float (*)[][*ku_bndi-*kl_bndi+1][*ju_bndi-*jl_bndi+1][two_physicaldata][*nfluxes]) c_amr_get_pointer("flux_x");
(*flux_x)[0][0][0][0][0] = (*flux_x)[0][0][0][0][0];

float (*flux_y)[*maxblocksfl][*ku_bndi-*kl_bndi+1][two_physicaldata][*iu_bndi-*il_bndi+1][*nfluxes];
flux_y = (float (*)[][*ku_bndi-*kl_bndi+1][two_physicaldata][*iu_bndi-*il_bndi+1][*nfluxes]) c_amr_get_pointer("flux_y");
(*flux_y)[0][0][0][0][0] = (*flux_y)[0][0][0][0][0];

float (*flux_z)[*maxblocksfl][two_physicaldata][*ju_bndi-*jl_bndi+1][*iu_bndi-*il_bndi+1][*nfluxes];
flux_z = (float (*)[][two_physicaldata][*ju_bndi-*jl_bndi+1][*iu_bndi-*il_bndi+1][*nfluxes]) c_amr_get_pointer("flux_z");
(*flux_z)[0][0][0][0][0] = (*flux_z)[0][0][0][0][0];

float (*tflux_x)[*maxblocksfl][*ku_bndi-*kl_bndi+1][*ju_bndi-*jl_bndi+1][two_physicaldata][*nfluxes];
tflux_x = (float (*)[][*ku_bndi-*kl_bndi+1][*ju_bndi-*jl_bndi+1][two_physicaldata][*nfluxes]) c_amr_get_pointer("tflux_x");
...
tflux_y = (float (*)[][*ku_bndi-*kl_bndi+1][two_physicaldata][*iu_bndi-*il_bndi+1][*nfluxes]) c_amr_get_pointer("tflux_y");
...
tflux_z = (float (*)[][two_physicaldata][*ju_bndi-*jl_bndi+1][*iu_bndi-*il_bndi+1][*nfluxes]) c_amr_get_pointer("tflux_z");
...
tbedge_facex_z = (float (*)[][*ku_bnd+1][*ju_bnd+1][two_physicaldata][*nedges]) c_amr_get_pointer("tbedge_facex_z");
...
tbedge_facey_x = (float (*)[][*ku_bnd+1][two_physicaldata][*iu_bnd+1][*nedges]) c_amr_get_pointer("tbedge_facey_x");
...
tbedge_facey_z = (float (*)[][*ku_bnd+1][two_physicaldata][*iu_bnd+1][*nedges]) c_amr_get_pointer("tbedge_facey_z");
...
tbedge_facez_x = (float (*)[][two_physicaldata][*ju_bnd+1][*iu_bnd+1][*nedges]) c_amr_get_pointer("tbedge_facez_x");
...
tbedge_facez_y = (float (*)[][two_physicaldata][*ju_bnd+1][*iu_bnd+1][*nedges]) c_amr_get_pointer("tbedge_facez_y");
...
i_divf_fc_vars = (int (*)[][three_physicaldata]) c_amr_get_pointer("i_divf_fc_vars");
