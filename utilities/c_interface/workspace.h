...
work = (float (*) [][*juw][*iuw][*maxblocksw][*nvar_work]) c_amr_get_pointer("work");
...
work1 = (float (*)[][*kuw1][*juw1][*iuw1]) c_amr_get_pointer("work1");
(*work1)[0][0][0][0] = (*work1)[0][0][0][0];

if (*curvilinear == 1) {
float (*cell_vol_w) [*kuw1][*juw1][*iuw1];
cell_vol_w = (float (*)[][*juw1][*iuw1]) c_amr_get_pointer("cell_vol_w");
